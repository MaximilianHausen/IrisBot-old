...
public sealed class GuildIrisConnection : BaseIrisConnection
{
    ...
    #region Audio
    public IrisAudioConnection GetAudioConnection(DiscordChannel channel) => channel.Guild != (module as GuildIrisModule).Guild ? null : AudioConnectionManager.GetConnection(channel);
    #endregion
